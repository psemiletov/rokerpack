...
GuitarMeterPanel::GuitarMeterPanel()
...
void GuitarMeterPanel::updateValues (float detectedFrequency, 
...
void GuitarMeterPanel::timerCallback()
{
    smoothedCents = currentCentsDeviation;
    repaint();
}

void GuitarMeterPanel::paint (juce::Graphics& g)
{
...
void GuitarMeterPanel::drawVerticalMeter (juce::Graphics& g, juce::Rectangle<int> area)
{
    ...
    // ← ИСПРАВЛЕНО: ограничиваем центер в диапазон
